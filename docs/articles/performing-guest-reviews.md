...
![Identity Governance](images/performing-guest-reviews/guestreviews1.png)

3. Navigate to **Access Reviews** and click **New Access Review**.  
![Access Reviews](images/performing-guest-reviews/guestreviews2.png)

4. Under the *Review Type* tab, select the Type of Review being created (Teams + Groups, or Applications).  
![Review Type](images/performing-guest-reviews/guestreviews3.png)
...
![Review Scope](images/performing-guest-reviews/guestreviews4.png)
...
![Review Stages](images/performing-guest-reviews/guestreviews5.png)
...
![Scenarios](images/performing-guest-reviews/guestreviews6.png)
...
![Settings](images/performing-guest-reviews/guestreviews7.png)
...
![Please review guest access](images/performing-guest-reviews/guestreviews8.png)
![Access reviews](images/performing-guest-reviews/guestreviews9.png)
![Review guest access across Microsoft 365 groups](images/performing-guest-reviews/guestreviews10.png)
![Access reviews completed](images/performing-guest-reviews/guestreviews11.png)
...
![Access review details](images/performing-guest-reviews/guestreviews12.png)
![Access review details - progress](images/performing-guest-reviews/guestreviews13.png)
![Access review details - results](images/performing-guest-reviews/guestreviews14.png)
![Review results](images/performing-guest-reviews/guestreviews15.png)
