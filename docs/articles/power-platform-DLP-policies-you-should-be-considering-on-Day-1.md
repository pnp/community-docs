...
![Image of the Assign connectors page.](images/power-platform-DLP-policies-you-should-be-considering-on-Day-1/Image02.png)
...
![Image of the new policy page.](images/power-platform-DLP-policies-you-should-be-considering-on-Day-1/Image03.png)

Select the environment(s) you wish your policy to apply to.

![Image of the Environments page in a new policy creation.](images/power-platform-DLP-policies-you-should-be-considering-on-Day-1/Image04.png)

Publish your policy.

![Image of the Data policies page showing a message that your new policy has been successfully created.](images/power-platform-DLP-policies-you-should-be-considering-on-Day-1/Image05.png)
