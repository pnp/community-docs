...
![Solution overview chart containing the information found in the following paragraph.](images/should-everyone-create-teams/solution-overview.png)
...
![Image of session invitation flow.](images/should-everyone-create-teams/LuiseFreese-LowCodeTeamsProvisioning-flow-session-invitation.png)
...
![SP List columns.](images/should-everyone-create-teams/demo-answers-to-quiz.png)
...
![SP List results.](images/should-everyone-create-teams/LuiseFreese-LowCodeTeamsProvisioning-SP-List-results.png)
...
![flow initialize vars](images/should-everyone-create-teams/LuiseFreese-LowCodeTeamsProvisioning-flow-initialize-vars.png)
...
![flow check membership](images/should-everyone-create-teams/LuiseFreese-LowCodeTeamsProvisioning-flow-check-membership.png)
...
![flow create item](images/should-everyone-create-teams/LuiseFreese-LowCodeTeamsProvisioning-flow-create-item.png)
...
![flow invite](images/should-everyone-create-teams/LuiseFreese-LowCodeTeamsProvisioning-flow-invite.png)
...
![flow Adaptive Cards](images/should-everyone-create-teams/LuiseFreese-LowCodeTeamsProvisioning-flow-AC.png)
...
![get tested user](images/should-everyone-create-teams/LuiseFreese-LowCodeTeamsProvisioning-get-tested-user.png)
...
![flow log request](images/should-everyone-create-teams/LuiseFreese-LowCodeTeamsProvisioning-flow-log-request.png)
...
![initialize variable](images/should-everyone-create-teams/LuiseFreese-LowCodeTeamsProvisioning-2ndflow-initialize-vars.png)
...
![managers approval](images/should-everyone-create-teams/LuiseFreese-LowCodeTeamsProvisioning-2ndflow-managers-approval.png)
...
![managers-approval with outcome not approved](images/should-everyone-create-teams/LuiseFreese-LowCodeTeamsProvisioning-2ndflow-managers-approvalNO.png)
...
![managers approval with outcome approved](images/should-everyone-create-teams/LuiseFreese-LowCodeTeamsProvisioning-2ndflow-managers-approvalYES.png)
...
![parse json](images/should-everyone-create-teams/LuiseFreese-LowCodeTeamsProvisioning-2ndflowparsejson.png)

Now it's time to use another two HTTP calls for creating the Team and adding the channel:

![flow to update a team](images/should-everyone-create-teams/LuiseFreese-LowCodeTeamsProvisioning-2ndflowupdateteam.png)
...
![provision bot](images/should-everyone-create-teams/provisionbot.gif)
