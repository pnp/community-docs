...
![Site settings page.](images/how-do-site-columns-become-managed-properties-thus-available-for-search/sposearch01.png)

Choose **Create**

![Create new site column.](images/how-do-site-columns-become-managed-properties-thus-available-for-search/sposearch02.png)
...
![New site column creation.](images/how-do-site-columns-become-managed-properties-thus-available-for-search/sposearch03.png)
...
![Site column group.](images/how-do-site-columns-become-managed-properties-thus-available-for-search/sposearch04.png)
...
![Navigate to library settings.](images/how-do-site-columns-become-managed-properties-thus-available-for-search/sposearch05.png)

In the column section, choose to add a column from an existing Site Column.

![Add site column to library.](images/how-do-site-columns-become-managed-properties-thus-available-for-search/sposearch06.png)

The Site Column is now ready to be used in the library, and you can now add values to the column in the list or library.

![Site column available in the library view.](images/how-do-site-columns-become-managed-properties-thus-available-for-search/sposearch07.png)
...
![Search administration page.](images/how-do-site-columns-become-managed-properties-thus-available-for-search/sposearch08.png)
...
![Crawled search page.](images/how-do-site-columns-become-managed-properties-thus-available-for-search/sposearch09.png)
...
![Refinable string search.](images/how-do-site-columns-become-managed-properties-thus-available-for-search/sposearch10.png)
...
![RefinableString01 settings.](images/how-do-site-columns-become-managed-properties-thus-available-for-search/sposearch11.png)
...
![Mapping of crawled properties to mapped properties.](images/how-do-site-columns-become-managed-properties-thus-available-for-search/sposearch12.png)

![RefinableString01 mapped to crawled property.](images/how-do-site-columns-become-managed-properties-thus-available-for-search/sposearch13.png)
...
![Search and offline availability menu item.](images/how-do-site-columns-become-managed-properties-thus-available-for-search/sposearch14.png)

Click **Reindex site** then OK, then wait… [Insert patience here]

![Search and offline availability.](images/how-do-site-columns-become-managed-properties-thus-available-for-search/sposearch15.png)

When the index has been updated you will be able to search for content that has your Site Column metadata as shown below.

![Search by using your new managed property 1.](images/how-do-site-columns-become-managed-properties-thus-available-for-search/sposearch16.png)

![Search by using your new managed property 2.](images/how-do-site-columns-become-managed-properties-thus-available-for-search/sposearch17.png)
...
![PnP Modern Search web part.](images/how-do-site-columns-become-managed-properties-thus-available-for-search/sposearch18.png)
...
![PnP Modern Search page in Teams.](images/how-do-site-columns-become-managed-properties-thus-available-for-search/sposearch19.png)
