...
![Step 1: Register app in AD.](images/how-to-deploy-teams-app-templates/1registeraapp.gif)
...
![Step 2: Deploy template.](images/how-to-deploy-teams-app-templates/2deploy.gif)

## Add authentication

Microsoft Entra ID can easily manage authentication, connect our bot with it, and set the scope as in our app registration.

![Step 3: Add authentication.](images/how-to-deploy-teams-app-templates/3addauthentication.gif)
...
![package your app.](images/how-to-deploy-teams-app-templates/4package.gif)
