...
![“Show progress” button while uploading](images/importing-data/drag-drop-show-progress.png)
...
![“Show progress” button while copying](images/importing-data/upload-files-folders-show-progress.png)
...
![Select the source files](images/importing-data/copy-to-files.png)

- Select the target location (i.e. “Your OneDrive”).

![Select the target location](images/importing-data/copy-to-files-target-location.png)
...
![“Show progress” button copying files](images/importing-data/copy-to-files-show-progress.png)
...
![Target location moving files](images/importing-data/move-to-folder-target-location.png)
...
![“Show progress” progress bar](images/importing-data/move-to-show-progress.png)
...
![Step 1 of 2 - Excel export](images/importing-data/excel-export-step1.png)

- Review the list design and click “Finish”.

![Step 2 of 2 - Excel export](images/importing-data/excel-export-step2.png)

- Click the URL to view the new SharePoint list. Click “OK” to exit the export wizard.

![Successful Excel export ok screen](images/importing-data/excel-export-ok.png)

- Example exported list shown below:

![Successful Excel export list view](images/importing-data/excel-export-list.png)
...
![Step 1 of 2 - Excel import](images/importing-data/excel-import-wizard-step1.png)
...
![Step 2 of 2 - Excel import](images/importing-data/excel-import-wizard-step2.png)

- Example imported list shown below:

![Successful Excel import](images/importing-data/excel-import-list.png)
...
![Save or no thanks](images/importing-data/spmt-save-migration.png)

- The summary screen will provide migration details and reports.
![Migration details](images/importing-data/spmt-summary.png)
