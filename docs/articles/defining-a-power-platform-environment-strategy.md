...
![Personal Productivity Approach.](images/defining-a-power-platform-environment-strategy/Scenario01-Personal-Productivity.png)

Uses include: Personal Productivity Apps and Flows, Custom SharePoint Lists and Library forms.

### Scenario 2 – Departmental

![Departmental Approach.](images/defining-a-power-platform-environment-strategy/Scenario02-DepartmentEnvironments.png)
...
![Departmental and Application Approach.](images/defining-a-power-platform-environment-strategy/Scenario03-ApplicationEnvironments.png)
...
![Multi-Tenant ALM Approach.](images/defining-a-power-platform-environment-strategy/Scenario04-Multi-Tenant.png)
