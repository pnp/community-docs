...
![content type in Document library](images/content-type-propagation/ct1.png)

![content type in Teams](images/content-type-propagation/ct2.png)
...
![SharePoint content services](images/content-type-propagation/ct3.png)

You will see a set of content types, and you will probably recognize many of these.

![content type gallery](images/content-type-propagation/ct4.png)
...
![create new content type dialog](images/content-type-propagation/ct5.png)
...
![parent content type option](images/content-type-propagation/ct5.1.png)
...
![content type settings](images/content-type-propagation/ct6.png)
...
![content type advanced settings](images/content-type-propagation/ct7.png)
...
![content type publishing](images/content-type-propagation/ct8.png)
...
![document library settings](images/content-type-propagation/ct9.png)
...
![Adding new content type](images/content-type-propagation/ct10.png)

Choose your newly published **"content type"** and hit **"Apply"**.

![Applying new content type](images/content-type-propagation/ct11.png)
...
![new content type](images/content-type-propagation/ct12.png)
...
![site content type gallery](images/content-type-propagation/ct13.png)
...
![site content type advanced settings](images/content-type-propagation/ct14.png)
