...
![Screenshot of SharePoint View with simulated heat map](images/creating-useful-views-in-lists-libraries/creating-useful-views-in-lists-libraries-f-shape.png)
